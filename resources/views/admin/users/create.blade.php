    ...
    <form action="{{ route('admin.users.store') }}" method="POST" class="p-8">
        ...
        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            <div class="sm:col-span-3">
                ...
                <div class="mt-1">
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required autofocus maxlength="60" class="shadow-sm focus:ring-primary-500 focus:border-primary-500 block w-full sm:text-sm border-slate-300 rounded-md">
                </div>
            ...
            <div class="sm:col-span-3">
                ...
                <div class="mt-1">
                    <input type="email" name="email" id="email" value="{{ old('email') }}" required maxlength="100" class="shadow-sm focus:ring-primary-500 focus:border-primary-500 block w-full sm:text-sm border-slate-300 rounded-md">
                </div>
