    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="p-4 space-y-2">
                ...
                <a href="#" class="block px-4 py-3 bg-slate-50 hover:orange-50 hover:text-orange-700 rounded-lg border border-slate-100 transition-colors text-slate-700 font-medium flex items-center group">
