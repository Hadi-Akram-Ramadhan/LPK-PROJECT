    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-200 flex justify-between items-center">
                ...
                <a href="{{ route('admin.ujian.index') }}" class="text-xs font-bold text-accent-600 uppercase tracking-widest hover:underline">Lihat Semua</a>
            </div>
            <div class="p-6">
                ...
                <div class="bg-slate-50 rounded-lg p-4 border border-slate-100 flex justify-between items-center mb-4 last:mb-0">
                    <div>
                        ...
                        <p class="text-slate-500 text-sm mt-1 flex items-center">
                            ...
                            {{ $ujian->soals_count }} soal · {{ $ujian->pesertas_count }} peserta
                        </p>
                    </div>
                </div>
                @empty
                ...
                <div class="bg-blue-50/50 rounded-lg p-4 border border-blue-100 flex justify-between items-center mb-4 last:mb-0">
                    <div>
                        ...
                        <p class="text-blue-600 text-sm mt-1 flex items-center font-medium">
                            ...
                            {{ \Carbon\Carbon::parse($ujian->mulai)->format('d M Y, H:i') }}
                        </p>
                    </div>
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 border border-blue-200 italic">Mendatang</span>
                </div>
                @empty
                <div class="text-center py-6 border-2 border-dashed border-slate-200 rounded-lg text-slate-400 font-medium">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="p-4 space-y-2">
                ...
                <a href="{{ route('admin.image.index') }}" class="block px-4 py-3 bg-slate-50 hover:bg-orange-50 hover:text-orange-700 rounded-lg border border-slate-100 transition-colors text-slate-700 font-medium flex items-center group">
