    ...
    <form action="{{ route('admin.kelas.store') }}" method="POST" class="p-8">
        ...
        <div class="space-y-6">
            <div>
                ...
                <input type="text" name="nama" id="nama" value="{{ old('nama') }}" required autofocus maxlength="50" class="shadow-sm focus:ring-primary-500 focus:border-primary-500 block w-full sm:text-sm border-slate-300 rounded-md">
