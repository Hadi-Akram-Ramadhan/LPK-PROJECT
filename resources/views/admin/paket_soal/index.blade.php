...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;">
    ...
    <a href="{{ route('admin.paket-soal.create') }}" style="display:inline-flex;align-items:center;padding:10px 20px;border-radius:10px;font-size:13px;font-weight:600;text-decoration:none;background:#2563eb;color:#fff;gap:8px;">
...
<div style="background:#fff;border:1px dashed #e2e8f0;border-radius:16px;padding:60px;text-align:center;">
    ...
    <a href="{{ route('admin.paket-soal.create') }}" style="display:inline-flex;align-items:center;padding:10px 24px;border-radius:10px;font-size:13px;font-weight:600;text-decoration:none;background:#2563eb;color:#fff;">+ Buat Paket Soal</a>
</div>
@else
