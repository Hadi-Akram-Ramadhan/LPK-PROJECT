...
<div class="flex items-center space-x-4">
    <a href="{{ route('admin.paket-soal.show', $soal->paket_soal_id) }}" class="text-slate-500 hover:text-slate-700 transition-colors">
...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden max-w-4xl mx-auto">
    <form action="{{ route('admin.soal.update', $soal) }}" method="POST" class="p-8" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="pt-10 flex justify-end border-t border-slate-100 mt-8 gap-4">
            <a href="{{ route('admin.paket-soal.show', $soal->paket_soal_id) }}"
