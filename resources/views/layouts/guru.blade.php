...
<head>
    ...
    <title>UBT Learning LPK URISOWON - Guru</title>
    ...
    <div class="adm-wrap">
        <aside class="adm-side">
            ...
            <nav class="side-nav">
                ...
                <a href="{{ route('guru.kelas.index') }}" class="side-link {{ request()->routeIs('guru.kelas.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('guru.soal_buta_warna.index') }}" class="side-link {{ request()->routeIs('guru.soal_buta_warna.*') ? 'active' : '' }}">
