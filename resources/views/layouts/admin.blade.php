...
<head>
    ...
    <title>UBT Learning LPK URISOWON - Admin</title>
    ...
    <div class="adm-wrap">
        <aside class="adm-side">
            ...
            <nav class="side-nav">
                ...
                <a href="{{ route('admin.soal_buta_warna.index') }}" class="side-link {{ request()->routeIs('admin.soal_buta_warna.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.image.index') }}" class="side-link {{ request()->routeIs('admin.image.*') ? 'active' : '' }}">
