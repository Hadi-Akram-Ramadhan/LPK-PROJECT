...
<body>
    ...
    <div id="portrait-warning">
        <svg class="rotate-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M18 6a9 9 0 11-3.5-2.5"/>
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 2v4h-4"/>
        </svg>
