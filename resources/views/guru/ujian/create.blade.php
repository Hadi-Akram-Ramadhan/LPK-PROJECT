    ...
    <form action="{{ route('guru.ujian.store') }}" method="POST">
        ...
        <div class="grid-2 mb-6" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            <div>
                ...
                <input type="text" name="judul" class="w-full px-4 py-3 border border-slate-200 rounded-lg outline-none focus:border-blue-500" placeholder="Contoh: UTS Bahasa Korea Dasar" value="{{ old('judul') }}" maxlength="100" required>
            </div>
            <div>
        ...
        <div class="mb-6">
            ...
            <textarea name="deskripsi" class="w-full px-4 py-3 border border-slate-200 rounded-lg outline-none focus:border-blue-500" placeholder="Tuliskan keterangan singkat mengenai ujian ini..." rows="3" maxlength="300">{{ old('deskripsi') }}</textarea>
        </div>
