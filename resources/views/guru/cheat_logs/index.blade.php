                ...
                <tr class="hover:bg-slate-50 transition-colors {{ $log->status === 'pending' ? 'bg-red-50/30' : '' }}">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                        ...
                        <div class="flex justify-center space-x-2">
                            {{-- Izinkan --}}
                            <form action="{{ route('guru.cheat-logs.approve', $log) }}" method="POST" class="inline"
                                onsubmit="return confirm('Izinkan peserta ini melanjutkan ujian?');">
                                @csrf
                            ...
                            {{-- Tolak --}}
                            <form action="{{ route('guru.cheat-logs.approve', $log) }}" method="POST" class="inline"
                                onsubmit="return confirm('Tandai pelanggaran berat? Ujian dikunci permanen untuk peserta ini.');">
                                @csrf
