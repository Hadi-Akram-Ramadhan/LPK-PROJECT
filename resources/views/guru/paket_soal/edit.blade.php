...
<div style="max-width:600px;margin:0 auto;background:#fff;border-radius:16px;border:1px solid #e2e8f0;padding:32px;">
    <form action="{{ route('guru.paket-soal.update', $paketSoal) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div style="display:flex;justify-content:flex-end;gap:12px;padding-top:20px;border-top:1px solid #f1f5f9;">
            <a href="{{ route('guru.paket-soal.show', $paketSoal) }}" style="padding:10px 20px;border-radius:10px;border:1px solid #e2e8f0;font-size:13px;font-weight:600;color:#64748b;text-decoration:none;">Batal</a>
