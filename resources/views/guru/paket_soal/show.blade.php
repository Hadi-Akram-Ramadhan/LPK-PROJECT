...
@endsection
@section('header-sub', 'Guru / Bank Soal / ' . $paketSoal->nama)
...
<div style="background:#fff;border:1px solid #e2e8f0;border-radius:14px;padding:20px 24px;margin-bottom:20px;display:flex;justify-content:space-between;align-items:center;gap:16px;flex-wrap:wrap;">
    ...
    <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;">
        ...
        <a href="{{ route('guru.import.index', ['paket' => $paketSoal->id]) }}" style="display:inline-flex;align-items:center;gap:6px;padding:9px 16px;border-radius:10px;font-size:13px;font-weight:600;text-decoration:none;background:#fff;color:#059669;border:1.5px solid #059669;">
