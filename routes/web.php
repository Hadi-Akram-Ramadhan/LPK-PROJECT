...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/audio/stream/{filename}', [\App\Http\Controllers\Admin\AudioController::class, 'stream'])->name('audio.stream');
    ...
    Route::middleware('role:guru')->prefix('guru')->name('guru.')->group(function () {
        ...
        Route::get('/audio/stream/{filename}', [\App\Http\Controllers\Guru\AudioController::class, 'stream'])->name('audio.stream');
